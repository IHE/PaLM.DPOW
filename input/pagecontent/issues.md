...
### Significant Changes from the Initial Draft
...
- **Digital slide management / archival** - a DAWM-initiated request to the IMA to remove or archive a specific stored WSI (e.g., superseding an insufficient scan, removing a faulty image, or offloading to cold storage). This was drafted as a transaction for Rev 0.1 but removed because its conveyance is unsettled: whether to reuse `OML^O21` or define a dedicated message needs further analysis.
